...
initLanguage(function(CURRENT_LANG) {
  ...
  new Vue({
    el  : 'nav',
    data: {
      lang: CONTENT[CURRENT_LANG].lang,
      ...CONTENT[CURRENT_LANG].nav,
    },
    methods: {
      onclickLang: function(lang) {
